...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="col-md-6">
           <div class="card">
             <form action="#">
                <div class="mb-3 sponsorChild">
                    <label for="exampleFormControlInput1" class="form-label">Search Child by User BTS-ID</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Enter BTSID">
                </div>
            </form>
           </div>
            <div class="card ">
                    ...
                    <form action="#">
                        <div class="jakat-form">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="inputPassword4" class="form-label">Amount (BDT)</label>
                                    <input type="password" class="form-control" id="inputPassword4">
                                </div>
                            </div>
                        </div>
                        <div class="donate-card-button">
                            ...
                            <a class="btn custom-donate-btn" type="submit"  href="donate.html">Donate</a>
        ...
        <div class="col-md-4">
            <div class="card ">
                <a class="text-decoration-none" href="#">
                    ...
                    <div class="service-card-footer text-center">
